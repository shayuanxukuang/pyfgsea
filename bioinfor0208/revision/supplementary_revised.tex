...
\label{tab:s7}
\scriptsize
\resizebox{\textwidth}{!}{\input{data/table_S7_equivalence_summary.tex}}
\end{table}
...
\label{tab:s8}
\scriptsize
\resizebox{\textwidth}{!}{\input{data/table_S8_thread_audit.tex}}
\end{table}
...
\label{tab:s9}
\scriptsize
\resizebox{\textwidth}{!}{\input{data/table_S9_window_grid_summary.tex}}
\end{table}
