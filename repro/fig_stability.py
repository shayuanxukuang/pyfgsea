...
def run_stability_benchmark():
    ...
    res_init = pyfgsea.run_gsea(df_rnk, gmt, gene_col="Gene", score_col="Score", seed=42)
    ...
    for i in range(reps):
        ...
        res = pyfgsea.run_gsea(df_rnk, gmt, gene_col="Gene", score_col="Score", seed=seed)
    ...
    sns.stripplot(data=df_res, x="Pathway", y="LogP", color="black", alpha=0.3, jitter=True)
