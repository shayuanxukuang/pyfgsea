...
SUITE_VERSION = "figure1-dual-lane-v1"
...
# These hashes are generated by ``prepare_inputs.py`` using explicit UTF-8,
# LF newlines, and binary64 round-trip formatting.  Keeping them in the tagged
# evidence code prevents a rewritten manifest from silently selecting a
# different synthetic input while retaining the same seed prose.
EXPECTED_INPUT_SHA256: dict[str, dict[str, str]] = {
    "publication_main": {
        "ranks": "8a9b17eae272de35f269f97dfe67e02c774c63daa607d5cd5779944b35daa72c",
...
def verify_clean_git_checkout(
    ...
    if (
        ...
        raise RuntimeError("0.2.0 evidence requires an annotated release tag")
    return {
        "commit": commit,
