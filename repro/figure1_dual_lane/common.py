...
SUITE_VERSION = "figure1-dual-lane-v2"
...
LANE_CONTRACTS: dict[str, dict[str, str | None]] = {
    ...
    "current": {
        "pyfgsea_distribution_version": "0.2.0rc4",
        "pyfgsea_module_version": "0.2.0rc4",
...
REFERENCE_ARTIFACT_CONTRACTS: dict[str, dict[str, str]] = {
    ...
    "current": {
        ...
        "fgsea_tarball_sha256": (
            "223eede5c1c8f8a5979e51a40d7f373f0476aefc5c3525c323af5cf871798f"
        ),
    },
}
...
# These hashes are generated by ``prepare_inputs.py`` using explicit UTF-8 and
# LF newlines.  The historical normal generator differs in its last binary64
# bits across platform math libraries, so publication scores are frozen at 12
# significant decimal digits before hashing; the predeclared ties are rounded
# to one decimal place.  Keeping the hashes in the tagged evidence code prevents
# a rewritten manifest from silently selecting a different synthetic input.
EXPECTED_INPUT_SHA256: dict[str, dict[str, str]] = {
    "publication_main": {
        "ranks": "7f6ee73545f4ae956132abe578fab95e6e3c2dab3ebfacaf1ca7bcf9024a4c58",
        "pathways": "65479dc646d30b1a4fb46337a69bbebc152a7ea616626e29360f76e991ed7ab5",
    },
    "ties_predeclared": {
        "ranks": "7b720b4e54dbfa18bba342665327d667346b91913d34017cf7b353c39d3eb7d1",
        "pathways": "02e6fc87957bd5bd31fbe46573516a7cd656214c788924169c8b2739a048558d",
    },
}
