...
| `current` | 0.2.0 | 0.2.0 | 4.6.0 | 3.23 | 1.38.0 | `fgsea-1.38-pr178-v1` |
...
Both lanes use `min_size=15`, `max_size=500`, `sample_size=101`, Python seed 1,
`nperm_nes=1800`, `eps=1e-50`, R seed 314, and one thread.  The current lane
...
python "${PYFGSEA_EVIDENCE_REPO}/repro/figure1_dual_lane/run_lane.py" \
  ...
  --expected-git-tag v0.2.0-rc1
```

Run the analogous current command in the 0.2.0 wheel environment with R
