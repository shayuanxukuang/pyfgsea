...
def plot_tail_consistency():
    ...
    if not result_dir.exists():
        print(f"Error: Directory {result_dir} not found. Please run repro/fig_ablation_tail.py first.")
    ...
    # R Confidence Band
    plt.fill_between(x, r_lows, r_highs, color='gray', alpha=0.3, label='R fgsea (95% CI)')
