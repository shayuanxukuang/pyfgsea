...
def run_window_sensitivity_supplement():
    ...
    sns.lineplot(data=final_df, x="Progress", y="NES", hue="Window Size", palette="viridis", linewidth=2.5, alpha=0.8)
    
    plt.title(f"Window Size Sensitivity: Heme Metabolism")
